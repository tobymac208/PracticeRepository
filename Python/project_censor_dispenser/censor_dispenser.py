...
def censor_text_negative_words_multiple(text):
  ...
  print('DEBUG: List of strings: ' + str(lst_of_strings))
  ...
  return(censor_text_multiple(string_to_modify))

print(censor_text_negative_words_multiple(email_three))
