...
# First, distinguish the comma from the delimiter'
between_data = '-'
between_sets = ','
daily_sales_replaced = daily_sales.replace(';,;', between_data)
print(daily_sales_replaced)

print_whitespace()

# Split each string into a transaction
daily_transactions = daily_sales_replaced.split(between_sets)
...
for set in transactions_clean:
    customers.append(set[0])
    sales.append(set[1])
    thread_sold.append(set[2])
print(customers)
print(sales)
print(thread_sold)
...
# Analyze the thread thread_sold array
print_whitespace()
print(thread_sold)
# split the string
thread_sold_split = []
